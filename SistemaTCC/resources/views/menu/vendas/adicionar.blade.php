    ...
    <div class="container">
        <div class="row">
            <div class="col col-12">
                ...
                <h1 class="text-center"><strong>Adicionar Venda</strong></h1>
                <form action="{{ asset('painel/vendas/adicionar') }}" method="POST">
                    @csrf

                    <div class="col col-10 offset-1 col-md-8 offset-md-2 mt-3 mb-3">
                        <label for="clienteVenda" class="form-label">Cliente</label>
                        <select class="custom-select" id="clienteVenda" name="cliente" required>
                    ...
                    <div class="col col-10 offset-1 col-md-8 offset-md-2 mt-3 mb-3">
                        ...
                        <input id="dataVenda" class="form-control" value="{{ date('d/m/Y') }}" name="data" required
                            disabled>
                    </div>
